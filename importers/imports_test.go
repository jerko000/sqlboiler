...
func TestAddTypeImports(t *testing.T) {
	...
	imports1 := Set{
		...
		ThirdParty: List{
			`"github.com/jerko000/sqlboiler/boil"`,
		},
	}
...
func TestMergeSet(t *testing.T) {
	...
	a := Set{
		Standard:   List{"fmt"},
		ThirdParty: List{"github.com/jerko000/sqlboiler", "github.com/volatiletech/null"},
	}
	b := Set{
		Standard:   List{"os"},
		ThirdParty: List{"github.com/jerko000/sqlboiler"},
	}
	...
	if c.ThirdParty[0] != "github.com/volatiletech/null" && c.ThirdParty[1] != "github.com/jerko000/sqlboiler" {
		t.Errorf("Wanted: github.com/jerko000/sqlboiler, github.com/volatiletech/null got: %#v", c.ThirdParty)
	}
}
