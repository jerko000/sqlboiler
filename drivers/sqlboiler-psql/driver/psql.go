...
func (p PostgresDriver) Imports() (importers.Collection, error) {
	...
	col.TestSingleton = importers.Map{
		...
		"psql_main_test": {
			...
			ThirdParty: importers.List{
				...
				`"github.com/jerko000/sqlboiler/randomize"`,
				`_ "github.com/lib/pq"`,
			},
		},
	}
	col.BasedOnType = importers.Map{
		...
		"types.JSON": {
			ThirdParty: importers.List{`"github.com/jerko000/sqlboiler/types"`},
		},
		"types.Decimal": {
			ThirdParty: importers.List{`"github.com/jerko000/sqlboiler/types"`},
		},
		...
		"pgeo.Point": {
			ThirdParty: importers.List{`"github.com/jerko000/sqlboiler/types/pgeo"`},
		},
		"pgeo.Line": {
			ThirdParty: importers.List{`"github.com/jerko000/sqlboiler/types/pgeo"`},
		},
